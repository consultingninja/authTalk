...
import { findUserByEmailWithPassword, updateUserPassword } from "../../backendUtils";
import { redirect,fail } from "@sveltejs/kit";
import type {Actions,RequestEvent,ActionFailure, Redirect} from '@sveltejs/kit';
import { SECRET_RESET } from "$env/static/private";
...
export const actions:Actions = {
    resetPassword: async({request,url}:RequestEvent): Promise<resetFormResponse|ActionFailure<resetFormResponse> | Redirect> =>{
        ...
        //passwords matching check done client side
        ...
        //password strength check done client side
